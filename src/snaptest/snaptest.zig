//! See: https://github.com/tigerbeetle/tigerbeetle/blob/a0aa383ddbf06a487393d3bb87f3d9edb63a79ff/src/testing/snaptest.zig
//!      https://ziggit.dev/t/microlibrary-for-testing-with-expectations/1115
//!
...
pub const Snap = struct {
    ...
    ///   - `SNAP_UPDATE` env var.
    fn shouldUpdate(snapshot: *const Snap) bool {
    ...
    pub fn diffFmt(snapshot: *const Snap, comptime fmt: []const u8, fmt_args: anytype) !void {
    ...
    pub fn diffJson(snapshot: *const Snap, value: anytype) !void {
